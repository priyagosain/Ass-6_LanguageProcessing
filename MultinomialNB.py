#This code is for plotting the Confusion matrix that pertains to MultinomialNB
...
# TruncatedSVD to select the principal components and reducing the dimensions
...
# Performing training
pipeline = Pipeline([("count_vectorizer", vectorizer),
                     ("features", combined_features), ("gnb", MultinomialNB())])
...
plot_confusion_matrix(cnf_matrix, classes=class_names,
                      title='Confusion matrix, without normalization (MultinomialNB)')

# Plot normalized confusion matrix
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=class_names, normalize=True,
                      title='Normalized confusion matrix (MultinomialNB)')
