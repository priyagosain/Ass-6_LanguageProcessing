#This code is for plotting the Confusion matrix that pertains to LogisticRegression
...
selection = SelectKBest(chi2, k=21)

# Combining the above selected features through FeatureUnion
combined_features = FeatureUnion([("pca", pca), ("univ_select", selection)])

# Performing training
pipeline = Pipeline([("count_vectorizer", vectorizer), ("features", combined_features), ("Logreg", LogisticRegression())])
